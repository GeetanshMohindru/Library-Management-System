...
(
	AUTHOR_ID NUMBER,
	ISBN  VARCHAR2(20),
	CONSTRAINT FK_AUTHOR_ID FOREIGN KEY (AUTHOR_ID) REFERENCES PROJECT1_AUTHORS (AUTHOR_ID),
	CONSTRAINT FK_ISBN FOREIGN KEY (ISBN) REFERENCES BOOKS(ISBN10)
);
...
(
	...
	ADDRESS VARCHAR2(300),
	PHONE VARCHAR2(15),
	ONSTRAINT PK_CARD_NO PRIMARY KEY (CARD_NO)
);

CREATE TABLE BOOK_HAVE_COPIES
(
	BOOK_ID VARCHAR2(10),
	AVAILIABLE CHAR(1),
	ISBN10 VARCHAR2(15),
